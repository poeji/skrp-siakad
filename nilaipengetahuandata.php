...
<h1><div align="center">Data Pengetahuan</div></h1><br /><hr><br />
<body>
        ...
        <table width="708" border="0" cellpadding="0" cellspacing="0" class="tinytable" id="table">
            <thead>
							  <tr>
                                  ...
                                  <th width="30%"><h3>Tahun Ajaran</h3></th>
								  <th width="20%"><h3>Semester</h3></th>
							  </tr>
                              </thead>
            <tbody>
						  <?php
...
WHERE thn_ajaran in ('$mintahun', '$plustahun') AND nip = '".$_SESSION["userid"]."'");
						  ...
						  ?>	
							<tr>	
								...
								<td class="center">
									<a class="btn btn-info" href="?page=nilaipengetahuantambahsubmit&kelas=<?php echo $d['kode_kelas']; ?>&pelajaran=<?php echo $d['kode_pelajaran']; ?>&tahun=<?php echo $d['thn_ajaran']; ?>&nip=<?php echo $d['nip']; ?>&semester=1" title="Lihat Detail Nilai Pengetahuan">
								 		Ganjil</a>|<a class="btn btn-info" href="?page=nilaipengetahuantambahsubmit&kelas=<?php echo $d['kode_kelas']; ?>&pelajaran=<?php echo $d['kode_pelajaran']; ?>&tahun=<?php echo $d['thn_ajaran']; ?>&nip=<?php echo $d['nip']; ?>&semester=2" title="Lihat Detail Nilai Pengetahuan">Genap  
									</a>
								</td>
							</tr>
							<?php } ?>
