...
WHERE k.kode_kelas = '".$_GET['kelas']."' AND k.thn_ajaran = '".$_GET['tahun']."'");
while($d = mysql_fetch_array($nilaipeng)) {

//nilai pengetahuan
$dip = mysql_fetch_array(mysql_query("SELECT * FROM `nilai_pengetahuan` WHERE nis = '".$_GET['nis']."' AND kode_pelajaran = '".$d['kode_pelajaran']."' AND tahun_ajaran = '".$_GET['tahun']."' AND semester = '".$_GET['semester']."'"));

//nilai keterampilan
$dk = mysql_fetch_array(mysql_query("SELECT * FROM `nilai_keterampilan` WHERE nis = '".$_GET['nis']."' AND kode_pelajaran = '".$d['kode_pelajaran']."' AND tahun_ajaran = '".$_GET['tahun']."' AND semester = '".$_GET['semester']."'"));

//nilai remed
$dr = mysql_fetch_array(mysql_query("SELECT * FROM `nilai_remed` WHERE nis = '".$_GET['nis']."' AND kode_pelajaran = '".$d['kode_pelajaran']."' AND tahun_ajaran = '".$_GET['tahun']."' AND semester = '".$_GET['semester']."'"));
...
<br />
<button type="button" class="btn" onclick="location.href='?page=lihatnilaisiswakelas'">Kembali</button>
