...
WHERE thn_ajaran in ('$mintahun', '$plustahun') AND nip = '".$_SESSION["userid"]."'");
						  ...
						  ?>	
							<tr>	
								...
								<td class="center">
									<a class="btn btn-info" href="?page=nilairemedtambahsubmit&kelas=<?php echo $d['kode_kelas']; ?>&pelajaran=<?php echo $d['kode_pelajaran']; ?>&tahun=<?php echo $d['thn_ajaran']; ?>&nip=<?php echo $d['nip']; ?>&semester=1" title="Lihat Detail Nilai Pengetahuan">
								 		Ganjil  
									</a> | 
                                    <a class="btn btn-info" href="?page=nilairemedtambahsubmit&kelas=<?php echo $d['kode_kelas']; ?>&pelajaran=<?php echo $d['kode_pelajaran']; ?>&tahun=<?php echo $d['thn_ajaran']; ?>&nip=<?php echo $d['nip']; ?>&semester=2" title="Lihat Detail Nilai Pengetahuan">
								 		Genap  
									</a>
								</td>
							</tr>
