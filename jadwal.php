<?php 
$hasil=mysql_query("SELECT k.`nama_kelas`, j.`jam`, j.`hari`, p.`nama_pelajaran`, j.`id_jadwal`, g.nama_guru, j.id_jadwal FROM jadwal j
LEFT JOIN `kelas` k ON k.`kode_kelas` = j.`kode_kelas`
	...
	<div class="page" id="tablewrapper">
        ...
        <table width="708" border="0" cellpadding="0" cellspacing="0" class="tinytable" id="table">
			...
			<td class="center"><?php echo hari($d['hari']); ?></td>
								...
								<td class="center">
									<a href="?page=jadwaledit&id=<?php echo $d['id_jadwal']; ?>">
										<img src=icon/update.png border=0>
									</a>
									<a href="?page=jadwalhapus&id=<?php echo $d['id_jadwal']; ?>" onClick="return confirm('Apakah anda yakin akan menghapus data ini ?');">
