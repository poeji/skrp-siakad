<?php 
$hasil=mysql_query("SELECT k.`nama_kelas`, j.`jam`, j.`hari`, p.`nama_pelajaran`, j.`id_jadwal`, g.nama_guru FROM jadwal j
...
function cetakjadwal(id) {
    window.open("cetakjadwalguru.php?id="+id, "_blank", "toolbar=yes, scrollbars=yes, resizable=yes, top=500, left=500, width=900, height=600");
}
</script>
