...
<div id="login-holder">
	...
	<!-- start logo -->
	<div id="logo-login">
		<a href="index.html"><img src="images/shared/logo.png" width="470" height="45" alt="" /></a>
	</div>
	<!-- end logo -->
	...
	<div id="login-inner">
		...
		<tr>
			<th>Username</th>
			<td><input type="text"  class="login-inp" name="userid" /></td>
		</tr>
		<tr>
			<th>Password</th>
        ...
        <tr>
			<th>Login Sebagai</th>
			<td>&nbsp;<select name="akses" class="submit-select"id="akses">
            <option>---Pilih---</option>
