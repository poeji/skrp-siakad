...
<h2>Tambah Data Nilai Remed</h2>
					<form action="?page=nilairemedtambahproses" method="post">
					...
					<?php } ?>
					<button type="button" class="btn" onclick="location.href='?page=nilairemed'">Cancel</button>
					<br><br>		
                    <?php 
        ...
        <table width="708" border="0" cellpadding="0" cellspacing="0" class="tinytable" id="table">
            <thead>
							  <tr>
								  ...
								  <td width="10%"><h3>Nilai Remed</h3></td>
							  </tr>
                              </thead>
            <tbody>
						  <?php
						  ...
						  $det = mysql_fetch_array(mysql_query("SELECT * FROM `nilai_remed` 
						  ...
						  ?>
							<tr>
								...
								<td class="center"><input type="text" name="np1[]" style="width:40px" title="NP 1" value="<?php echo $det['nilairemed']; ?>"></td>
							</tr>
