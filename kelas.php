	...
	<div class="page" id="tablewrapper">
        ...
        <table width="708" border="0" cellpadding="0" cellspacing="0" class="tinytable" id="table">
			...
			<td class="center"><?php echo $d['kode_kelas']; ?></td>
								...
								<td class="center">
									<a href="?page=kelasedit&id=<?php echo $d['kode_kelas']; ?>">
										<img src=icon/update.png border=0>
									</a>
									<a href="?page=kelashapus&id=<?php echo $d['kode_kelas']; ?>" onClick="return confirm('Apakah anda yakin akan menghapus <?php echo $d['nama_kelas']; ?>?');">
